                        ...
                        <CardContent>
                            <div className="flex flex-col gap-4 mt-6">
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        // TODO: Replace this with actual OAuth logic (e.g., next-auth or Firebase)
                                        () => signIn("github", { callbackUrl: "/" })
                                        toast("Redirecting to GitHub OAuth...");
                                    }}
                                >
                                ...
                                <Button
                                    variant="default"
                                    className="w-full flex items-center bg-blue-800 text-white gap-2 justify-center cursor-pointer "
                                    onClick={() => {
                                        toast("Redirecting to Linkedin OAuth...");
                                    }}
                                >
