            ...
            <div className="px-4 py-6 md:px-8 lg:px-16">
                <div className="max-w-6xl mx-auto flex flex-col items-center justify-center py-32 text-center">
                    <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-4">
                        <FiBookOpen size={24} className="text-white/40" />
                    </div>
                    <h1 className="text-xl font-extrabold mb-2">Learn</h1>
                    <p className="text-white/40 text-sm max-w-sm">
                        Guides and tutorials to help you understand the markets. Coming soon.
                    </p>
                </div>
            </div>
        </div>
